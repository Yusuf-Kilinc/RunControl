...
namespace Ghost
{
    public class Matematiksel_islemler : MonoBehaviour
    {
        ...
        public static void Cikartma(int GelenSayi, List<GameObject> Karakterler, Transform Pozisyon)
        {
        ...
        public static void Bolme(int GelenSayi, List<GameObject> Karakterler, Transform Pozisyon)
        {
            if (GameManager.AnlikKarakterSayisi <= GelenSayi)
            {
                foreach (var item in Karakterler)
